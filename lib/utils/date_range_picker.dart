...
// void showRangePicker({context, setRange, beginDate}) {
//   FocusScope.of(context).unfocus();
//   print("Value is setRange $setRange");
//   print("Value is setRange $beginDate");
//   showCrDatePicker(
//     context,
...
//       initialPickerDate: beginDate ?? DateTime.now(),
...
//           color: isPicked ? primaryColor : Colors.white,
//           borderRadius: const BorderRadius.all(Radius.circular(10)),
//         ),
//         child: Center(
//           child: Text(year.toString(),
//               style: TextStyle(
//                   color: isPicked ? Colors.white : Colors.black, fontSize: 16)),
//         ),
//       ),
...
//           child: Text("Ok", style: whiteRegular14),
//         ),
//       ),
...
//           child: Text(
//             "Cancel",
//             style: blackRegular14.copyWith(color: primaryColor),
//           ),
//         ),
//       ),
//     ),
...
//       child: Stack(
//         children: [
//           /// Semi transparent primaryColor background for days in selected range.
    ...
    for (int i = 0; true; i += 1) {
      ...
      if (day < 1) {
        ...
        if (isSelectedFirstDay && (isSelectedLastDay == null || isSelectedLastDay)) {
          ...
          decoration = BoxDecoration(color: ColorConstant.primaryColor, shape: BoxShape.circle);
          ...
          decoration = BoxDecoration(color: ColorConstant.primaryColor.withOpacity(0.1), shape: BoxShape.rectangle);
        } else if (disabled) {
          ...
          itemStyle = themeData.textTheme.bodyText1!.copyWith(color: ColorConstant.primaryColor);
        }
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        final TextStyle? itemStyle = isSelected ? themeData.textTheme.headline1!.copyWith(color: themeData.colorScheme.secondary) : style;
        return InkWell(
...
class _DatePickerDialogState extends State<_DatePickerDialog> {
  ...
  void _handleYearChanged(List<DateTime> changes) {
    ...
    setState(() {
      ...
      _selectedLastDate = changes.length > 1 ? changes[1] : changes[0];
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final Dialog dialog = Dialog(child: OrientationBuilder(builder: (BuildContext context, Orientation orientation) {
      ...
      final Widget header = _DatePickerHeader(
        selectedFirstDate: _selectedFirstDate!,
        selectedLastDate: _selectedLastDate == null ? _selectedFirstDate! : _selectedLastDate!,
        mode: _mode!,
