...
class Showcase1 extends StatefulWidget {
  @override
  final GlobalKey key;
  ...
  @override
  _Showcase1State createState() => _Showcase1State();
}

class _Showcase1State extends State<Showcase1> with TickerProviderStateMixin {
...
class ShowCaseWidget extends StatefulWidget {
  ...
  static GlobalKey<State<StatefulWidget>>? activeTargetWidget(BuildContext context) {
...
bool isLoaded = false;
  ...
  void initState() {
    super.initState();
    ids = [_one, _two, _three, _four, _five, _six, _seven, _eight, _nine];
  ...
  void completed(GlobalKey id) {
    if (ids != [] && ids[activeWidgetId] == id && mounted) {
      setState(() {
        _onComplete();
